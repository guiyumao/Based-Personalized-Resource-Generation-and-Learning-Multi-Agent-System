...
- 学生端支持学习路径、课件学习、课后自测、错题本、重练题、学习报告、知识图谱与智能答疑
...
- 当前默认返回 1 份正式模型课件，优先保证稳定生成与响应成功率
- 如需扩展多版本课件，可通过 `RESOURCE_COURSEWARE_VARIANT_COUNT` 再开启更多候选版本
- 前端会直接展示本次返回的正式模型课件，避免因额外候选版本拖慢主流程
